  ...
  <section>
    ...
    <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
      <el-form :inline="true" :model="filters">
        <el-form-item>
          <el-input v-model="filters.title" placeholder="通知标题"></el-input>
        </el-form-item>
    ...
    <!--列表-->
    <el-table :data="notice" highlight-current-row v-loading="listLoading">
    ...
    <el-dialog title="编辑" :visible.sync="editFormVisible" :close-on-click-modal="false">
      <el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
        ...
        <el-form-item>
          ...
          <el-button type="primary" @click.native="editNoticeSubmit" :loading="editLoading">提交</el-button>
        </el-form-item>
      </el-form>
    </el-dialog>
...
<script>
import { getNoticeListPage, editNotice, removeNotice } from "../../api"
